...
int stream_server_init(char *ipif, int port, int dscp, int mtu, int cons, int streams, int vqno,int vqlen, int aqno, int aqlen, int (*frm_cb)(int type, int qno, gm_ss_entity *entity), int (*cmd_cb)(char *name, int sno, int cmd, void *p));
...
int stream_reg(char *name, int vqno, char *vsdpstr, int aqno, char *asdpstr, int live, unsigned int v_mc_ip, int v_mc_port, unsigned int a_mc_ip, int a_mc_port, char *username, char *password);
