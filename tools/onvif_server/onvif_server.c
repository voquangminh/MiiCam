...
static int motor_position(int*x,int*y){int a=0,b=0;if(motor_ioctl_int(H_COORD_GET,&a)<0||motor_ioctl_int(V_COORD_GET,&b)<0)return-1;*x=ptz.x;*y=ptz.y;return 0;}
